...
interface IProductIRSModule is IProduct {
     ...
     * @param poolAddress Address of pool to settle in
     */
    function settle(uint128 accountId, uint128 marketId, uint32 maturityTimestamp, address poolAddress) external;
